...
func _make_materials() -> void:
	_mat_body  = MeshBuilder.emit_mat(Color(0.55,0.95,0.88), Color(0.25,0.90,0.78), 1.6)
	_mat_dark  = MeshBuilder.emit_mat(Color(0.04,0.22,0.20), Color(0.04,0.30,0.26), 0.8)
	_mat_light = MeshBuilder.emit_mat(Color(0.85,1.00,0.96), Color(0.50,1.00,0.92), 2.2)
	_mat_eye   = MeshBuilder.emit_mat(Color(1.00,0.95,0.40), Color(1.00,0.90,0.20), 3.0)
