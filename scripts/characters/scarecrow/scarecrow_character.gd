## scarecrow/scarecrow_character.gd
## Sinh vật thù địch: Bù Nhìn Ác Quỷ (Haunted Scarecrow) — đồng bằng.
## Đi chậm rãi rình rập, máu dày, giơ tay đập mạnh khi tới gần. Chết drop
## Straw Ribbon (mảnh rơm quấn bù nhìn). Chỉ gặp về đêm.

extends CharacterBase
class_name ScarecrowCharacter

const HP: float = 34.0
const ATK: int = 6
const SPEED: float = 1.7
const SCALE: float = 1.35
...
const EXP_DROP_RATE: float = 0.30

var _mesh: ScarecrowMesh
var _home: Vector3 = Vector3.ZERO
var _player: Node3D = null
var _attack_cd: float = 0.0
var _target_dir: Vector3 = Vector3.FORWARD
var _base_move_speed: float = 1.7
...
func _roll_loot() -> void:
	...
	var defn: ItemDef = ItemDatabase.items_db.get("straw_ribbon")
	if defn and randf() < 0.85 * get_rate_mult():
