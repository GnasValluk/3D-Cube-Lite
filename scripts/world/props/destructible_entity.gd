## destructible_entity.gd — Vật đặt được (rương, bàn chế tạo, lò nung,...)
## có máu như cây cối: đòn heavy (rìu/cúp/cuốc/đại kiếm) làm giảm HP,
## bị phá huỷ sẽ rớt lại vật phẩm tương ứng; nếu có kho chứa riêng (rương)
## thì đổ toàn bộ đồ bên trong ra ngoài.
...
var max_hp: int = 60
var hp: int
var weapon_requirement: int = WeaponReq.HEAVY
...
## Rớt lại vật phẩm tương ứng (rương → item rương, v.v.).
...
## Đổ toàn bộ đồ trong kho riêng ra ngoài (ghi đè ở rương).
