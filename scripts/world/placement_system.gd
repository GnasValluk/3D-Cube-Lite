...
func _ready() -> void:
	_buildings.append({ "key": "twilight_portal", "type": "unique", "placed": false, "name": "Cổng Thế Giới Chạng Vạng", "desc": "Mở cổng đến thế giới Chạng Vạng", "dest_dim": _Dim.DimensionID.TWILIGHT })
	_buildings.append({ "key": "real_world_portal", "type": "unique", "placed": false, "name": "Cổng Thế Giới Thực Tại", "desc": "Mở cổng đến Thế Giới Thực Tại", "dest_dim": _Dim.DimensionID.REAL_WORLD })

	_buildings.append({ "key": "floor_grass", "type": "tile", "tile_type": DecorativeTile.TileType.GRASS, "name": "Thềm Cỏ Chạng Vạng", "desc": "Thềm cỏ phát quang tím" })
	_buildings.append({ "key": "floor_dark_grass", "type": "tile", "tile_type": DecorativeTile.TileType.DARK_GRASS, "name": "Thềm Cỏ Xanh Đậm", "desc": "Thềm cỏ xanh đậm chạng vạng" })
	_buildings.append({ "key": "floor_flower", "type": "tile", "tile_type": DecorativeTile.TileType.FLOWER, "name": "Thềm Hoa Chạng Vạng", "desc": "Thềm hoa phát quang" })
	_buildings.append({ "key": "floor_mushroom", "type": "tile", "tile_type": DecorativeTile.TileType.MUSHROOM, "name": "Thềm Nấm Chạng Vạng", "desc": "Thềm nấm phát quang" })
	_buildings.append({ "key": "floor_green", "type": "tile", "tile_type": DecorativeTile.TileType.GREEN, "name": "Thềm Xanh Lục", "desc": "Thềm xanh lục chạng vạng" })
