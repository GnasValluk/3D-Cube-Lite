...
static func create_item_db() -> Dictionary:
	...
	_add(db, "ak_12", "Súng Trường AK-12 Thunderbolt", ItemDef.Type.WEAPON, Color(0.20, 0.24, 0.18), "🔫", "Súng trường điện tử AK-12 Thunderbolt — thân void đen dải neon vàng, bắn tự động đạn 7,62mm pha năng lượng. Đạn gây 80% Dmg Vật Lý + 20% Dmg Lôi khi trúng đích", false, 1, 0, 8, 0, -1, 400)
